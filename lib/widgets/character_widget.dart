...
import 'package:character_app/pages/character_details_screen.dart';
...
class CharacterWidget extends StatelessWidget {
  ...
  const CharacterWidget({Key? key, required this.character, required this.pageController, required this.currentPage})
      : super(key: key);
